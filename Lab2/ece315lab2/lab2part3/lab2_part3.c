...
void vBufferReceiveTask(void *p)
{
    ...
    char formattedChar;
    u32 ssd_value = 1;
    unsigned int sendMethod = 0, swVal, buttonVal = 0, prevMethod = sendMethod;
    ...
    while (1)
    {
        ...
        while (myReceiveData() == pdFALSE){
            ...
            if (sendMethod != prevMethod) xil_printf("\n");
            prevMethod = sendMethod;
