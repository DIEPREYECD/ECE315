...
#define PWM_REPEAT_COUNT 24414 // x = 24414*32 pwm values * 32 cycles per value
                               //     * 10 clock cycles per cycle / 125e6 cycles per second
                               //  ~= 2 seconds
...
int main()
{
    ...
    pio_serialiser_program_init(pio0, 0, offset, LED_PIN, PIO_SERIAL_CLKDIV);
